package com.gitbub.maicmiller.citiesapi.cities;
...
/*
* Essa classe é um instrução para o spring ensinar o hibernate a mapear a Classe ponto.
* Que é a responsavel pelo ponto geospacial.
* */
